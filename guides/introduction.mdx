---
title: Introduction
description: Welcome to the Dodo Payments Guides - built to help you seamlessly integrate secure, scalable, and customizable payment solutions into your stack
icon: "book-open"
---
...
<CardGroup cols={2}>
  <Card title="Products" icon="box" href="/features/products#managing-products">
